    ...
    <>
      ...
      <div className="about-container">
        ...
        <div className="about-content-column">
          ...
          <p className="description-text">
            Instead of losing fresh tomatoes due to poor storage, lack of
            buyers, or transport challenges, users can quickly find trusted
            partners, manage orders, and move produce safely from farm to
            market.
          </p>

          <p className="description-text">
            Our goal is to reduce food waste, improve farmers' income, and
            ensure fresh tomatoes reach consumers on time.
          </p>
          ...
          <div className="cards-row">
            <div className="green-card">
              ...
              <p className="card-text">
                ...
                transport providers, and cold storage facilities to work
                together.
              </p>
            </div>
